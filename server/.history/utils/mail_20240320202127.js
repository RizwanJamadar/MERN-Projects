...
export const sendMail = async (mail,status) => {
  ...
  const approvedMailOptions = {
    ...
    html: `<p>Dear ${approvedStaffName},</p><p>Your leave request has been approved. You are granted leave for the requested period.</p><p>Best Regards,<br>[Your College Name] Leave Management Team</p>`,
  };
  ...
  const rejectedMailOptions = {
    ...
    html: `<p>Dear ${rejectedStaffName},</p><p>We regret to inform you that your leave request has been rejected. Please contact the administration for further clarification.</p><p>Best Regards,<br>[Your College Name] Leave Management Team</p>`,
  };
