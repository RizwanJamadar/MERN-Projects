  ...
  return (
    <Paper>
      ...
      <Dialog open={openReasonDialog} onClose={handleCloseReasonDialog}>
        ...
        <DialogActions>
          <Button onClick={handleCloseReasonDialog} color="primary" sx={{bgcolor:"red",color:"black"}}>
            Cancel
          </Button>
          <Button onClick={handleSubmitReason} color="primary" sx={{bgcolor:"green",color:"black"}}>
            Submit
          </Button>
        </DialogActions>
      </Dialog>
