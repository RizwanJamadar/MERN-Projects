...
const AllLeaves = () => {
  ...
  const columns = [
    ...
    { id: "startDate", label: "From", minWidth: 100, render: (rowData) => formatDate(rowData.startDate) },
    { id: "endDate", label: "To", minWidth: 100, render: (rowData) => formatDate(rowData.endDate) },
