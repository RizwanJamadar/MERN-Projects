    ...
    try {
      const response = await axios.get(
        "https://api.api-ninjas.com/v1/holidays",
        {
          ...
          headers: {
            "X-Api-Key": "hwtUa6Kmrp1g/1AZ5yZM4Q==n3cCIUDxjagi0CsA", // sR/5X5ybDEB/ZV8xV9dKWg==GXA4Yh5tY9TZmjJU
          },
        }
      );
